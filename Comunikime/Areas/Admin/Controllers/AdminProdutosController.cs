...
namespace Comunikime.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class AdminProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,Nome,Descricao,DescricaoCurta,Preco,ImagemUrl,ImagemThumbnailUrl,Estoque,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,Nome,Descricao,DescricaoCurta,Preco,ImagemUrl,ImagemThumbnailUrl,Estoque,CategoriaId")] Produto produto)
        {
